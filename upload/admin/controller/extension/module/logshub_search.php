...
class ControllerExtensionModuleLogshubSearch extends Controller
{
    ...
    public function index()
    {
        ...
        $data = array_merge($this->getVarArray(), $this->getSettingsArrayFromConfig());
    ...
    public function cron()
    {
        ...
        try {
            $client = $this->model_logshub_indexer->getClient(
                $this->config->get('module_logshub_search_api_url'), $this->config->get('module_logshub_search_api_hash'), $this->config->get('module_logshub_search_api_secret')
            );
